...
func newSymbolTable() map[string]*Codec {
	return map[string]*Codec{
		...
		// Start of compiled logical types using format typeName.logicalType
		// where there is no dependence on schema.
		"long.timestamp-millis": {
			typeName:          &name{"long.timestamp-millis", nullNamespace},
			schemaOriginal:    "long",
			schemaCanonical:   "long",
			nativeFromTextual: timeNativeFromLogicalTypeTimestampMillis(longNativeFromTextual),
			binaryFromNative:  logicalTypeTimestampMillisFromTimeNative(longBinaryFromNative),
			nativeFromBinary:  timeNativeFromLogicalTypeTimestampMillis(longNativeFromBinary),
			textualFromNative: logicalTypeTimestampMillisFromTimeNative(longTextualFromNative),
		},
		"long.timestamp-micros": {
			typeName:          &name{"long.timestamp-micros", nullNamespace},
			schemaOriginal:    "long",
			schemaCanonical:   "long",
			nativeFromTextual: timeNativeFromLogicalTypeTimestampMicros(longNativeFromTextual),
			binaryFromNative:  logicalTypeTimestampMicrosFromTimeNative(longBinaryFromNative),
			nativeFromBinary:  timeNativeFromLogicalTypeTimestampMicros(longNativeFromBinary),
			textualFromNative: logicalTypeTimestampMicrosFromTimeNative(longTextualFromNative),
		},
		"int.time-millis": {
			typeName:          &name{"int.time-millis", nullNamespace},
			schemaOriginal:    "int",
			schemaCanonical:   "int",
			nativeFromTextual: timeDurationNativeFromLogicalTypeTimeMillis(intNativeFromTextual),
			binaryFromNative:  logicalTypeTimeMillisFromNativeTimeDuration(intBinaryFromNative),
			nativeFromBinary:  timeDurationNativeFromLogicalTypeTimeMillis(intNativeFromBinary),
			textualFromNative: logicalTypeTimeMillisFromNativeTimeDuration(intTextualFromNative),
		},
		"long.time-micros": {
			typeName:          &name{"long.time-micros", nullNamespace},
			schemaOriginal:    "long",
			schemaCanonical:   "long",
			nativeFromTextual: timeDurationNativeFromLogicalTypeTimeMicros(longNativeFromTextual),
			binaryFromNative:  logicalTypeTimeMicrosFromNativeTimeDuration(longBinaryFromNative),
			nativeFromBinary:  timeDurationNativeFromLogicalTypeTimeMicros(longNativeFromBinary),
			textualFromNative: logicalTypeTimeMicrosFromNativeTimeDuration(longTextualFromNative),
		},
		"int.date": {
