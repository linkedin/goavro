...
type Codec struct {
	...
	binaryFromNativeOutput func(io.Writer, interface{}) error
...
func newSymbolTable() map[string]*Codec {
	return map[string]*Codec{
		"boolean": {
			...
			binaryFromNativeOutput: booleanBinaryFromNativeOutput,
		...
		"bytes": {
			...
			binaryFromNativeOutput: bytesBinaryFromNativeOutput,
		...
		"double": {
			...
			binaryFromNativeOutput: doubleBinaryFromNativeOutput,
		...
		"float": {
			...
			binaryFromNativeOutput: floatBinaryFromNativeOutput,
		...
		"int": {
			...
			binaryFromNativeOutput: intBinaryFromNativeOutput,
		...
		"long": {
			...
			binaryFromNativeOutput: longBinaryFromNativeOutput,
		...
		"null": {
			...
			binaryFromNativeOutput: nullBinaryFromNativeOutput,
		...
		"string": {
			...
			binaryFromNativeOutput: stringBinaryFromNativeOutput,
		...
		"long.timestamp-millis": {
			...
			binaryFromNativeOutput: timeStampMillisFromNativeOutput(longBinaryFromNativeOutput),
		...
		"long.timestamp-micros": {
			...
			binaryFromNativeOutput: timeStampMicrosFromNativeOutput(longBinaryFromNativeOutput),
		...
		"int.time-millis": {
			...
			binaryFromNativeOutput: timeMillisFromNativeOutput(intBinaryFromNativeOutput),
		...
		"long.time-micros": {
			...
			binaryFromNativeOutput: timeMicrosFromNativeOutput(longBinaryFromNativeOutput),
		...
		"int.date": {
			...
			binaryFromNativeOutput: dateFromNativeOutput(intBinaryFromNativeOutput),
